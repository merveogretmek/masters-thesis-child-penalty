...
# Split the data
bef_2007_ia = native_ia[native_ia['kidgeb01'] < 2007]
aft_2007_ia = native_ia[native_ia['kidgeb01'] >= 2007]
...
event_study_results.to_csv("../../data/processed/bef2007_results_ia_native.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_ia_native.csv", index=False)
...
# Split the data
bef_2007_ia = immigrant_ia[immigrant_ia['kidgeb01'] < 2007]
aft_2007_ia = immigrant_ia[immigrant_ia['kidgeb01'] >= 2007]
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/bef2007_results_ia_immigrant.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_ia_immigrant.csv", index=False)
...
# Split the data
bef_2007_wha = native_wha[native_wha['kidgeb01'] < 2007]
aft_2007_wha = native_wha[native_wha['kidgeb01'] >= 2007]
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/bef2007_results_wha_native.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_wha_native.csv", index=False)
...
# Split the data
bef_2007_wha = immigrant_wha[immigrant_wha['kidgeb01'] < 2007]
aft_2007_wha = immigrant_wha[immigrant_wha['kidgeb01'] >= 2007]
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/bef2007_results_wha_immigrant.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_wha_immigrant.csv", index=False)
...
# Split the data
bef_2007_esa = native_esa[native_esa['kidgeb01'] < 2007]
aft_2007_esa = native_esa[native_esa['kidgeb01'] >= 2007]
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/bef2007_results_esa_native.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_esa_native.csv", index=False)
...
# Split the data
bef_2007_esa = immigrant_esa[immigrant_esa['kidgeb01'] < 2007]
aft_2007_esa = immigrant_esa[immigrant_esa['kidgeb01'] >= 2007]
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/bef2007_results_esa_immigrant.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_esa_immigrant.csv", index=False)
