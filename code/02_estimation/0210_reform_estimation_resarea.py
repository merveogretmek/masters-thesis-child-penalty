# 0210 Reform Estimation - Residential Area
...
## Categorize into Regions (Rural vs Urban)
...
# Split the data
bef_2007_ia = rural_ia[rural_ia['kidgeb01'] < 2007]
aft_2007_ia = rural_ia[rural_ia['kidgeb01'] >= 2007]
...
event_study_results.to_csv("../../data/processed/bef2007_results_ia_rural.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_ia_rural.csv", index=False)
...
# Split the data
bef_2007_ia = urban_ia[urban_ia['kidgeb01'] < 2007]
aft_2007_ia = urban_ia[urban_ia['kidgeb01'] >= 2007]
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/bef2007_results_ia_urban.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_ia_urban.csv", index=False)
...
# Split the data
bef_2007_wha = rural_wha[rural_wha['kidgeb01'] < 2007]
aft_2007_wha = rural_wha[rural_wha['kidgeb01'] >= 2007]
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/bef2007_results_wha_rural.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_wha_rural.csv", index=False)
...
# Split the data
bef_2007_wha = urban_wha[urban_wha['kidgeb01'] < 2007]
aft_2007_wha = urban_wha[urban_wha['kidgeb01'] >= 2007]
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/bef2007_results_wha_urban.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_wha_urban.csv", index=False)
...
# Split the data
bef_2007_esa = rural_esa[rural_esa['kidgeb01'] < 2007]
aft_2007_esa = rural_esa[rural_esa['kidgeb01'] >= 2007]
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/bef2007_results_esa_rural.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_esa_rural.csv", index=False)
...
# Split the data
bef_2007_esa = urban_esa[urban_esa['kidgeb01'] < 2007]
aft_2007_esa = urban_esa[urban_esa['kidgeb01'] >= 2007]
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/bef2007_results_esa_urban.csv", index=False)
...
event_study_results.reset_index(inplace=True)
event_study_results.to_csv("../../data/processed/aft2007_results_esa_urban.csv", index=False)
